...
double PhaseDelayAudioProcessor::getTailLengthSeconds() const { return 0.0; }
...
int PhaseDelayAudioProcessor::getCurrentProgram() { return 0; }
...
void PhaseDelayAudioProcessor::changeProgramName(int index,
                                                 const juce::String &newName) {}

//==============================================================================
void PhaseDelayAudioProcessor::prepareToPlay(double sampleRate,
                                             int samplesPerBlock) {
...
#ifndef JucePlugin_PreferredChannelConfigurations
bool PhaseDelayAudioProcessor::isBusesLayoutSupported(
...
void PhaseDelayAudioProcessor::processBlock(juce::AudioBuffer<float> &buffer,
...
//==============================================================================
void PhaseDelayAudioProcessor::getStateInformation(
...
void PhaseDelayAudioProcessor::setStateInformation(const void *data,
                                                   int sizeInBytes) {
...
PhaseDelayAudioProcessor::createParameterLayout() {
  std::vector<std::unique_ptr<juce::RangedAudioParameter>> params;

  // Filter Type (Biquad / SVF)
  params.push_back(std::make_unique<juce::AudioParameterChoice>(
      "TYPE", "Filter Type", juce::StringArray{"Biquad", "SVF"}, 0));
  // Frequency (20Hz ~ 20000Hz)
  params.push_back(std::make_unique<juce::AudioParameterFloat>(
      "FREQ", "Frequency",
      juce::NormalisableRange<float>(20.0f, 20000.0f, 1.0f, 0.3f), 200.0f));
  // Q (0.005 ~ 1.414)
  params.push_back(std::make_unique<juce::AudioParameterFloat>(
      "Q", "Q", juce::NormalisableRange<float>(0.005f, 1.414f, 0.001f),
      0.707f));
  // Iterations (0 ~ 50)
  params.push_back(std::make_unique<juce::AudioParameterInt>(
      "ITER", "Iterations", 0, 50, 25));
  // Mix (0% ~ 100%)
  params.push_back(std::make_unique<juce::AudioParameterFloat>(
